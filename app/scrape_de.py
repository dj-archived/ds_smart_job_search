    ...
    for start in range(0, max_results_per_city, 10):
        ...
        for each in soup.find_all(class_= "result" ):
            ...
            try:
                ...
                summary = None
            df_de = df_de.append({'Title':title, 'Location':location, 'Company':company, 'Review':salary,'Summary':summary},
            ignore_index=True)
            i += 1
            if i % 1000 == 0:  # Ram helped me build this counter to see how many. You can visibly see Ram's vernacular in the print statements.
                print('You have ' + str(i) + ' results. ' + str(df_de.dropna().drop_duplicates().shape[0]) + " of these aren't rubbish.")
