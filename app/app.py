...
df1_encoding = find_encoding(
    "./data/Global-Artificial-Intelligence-Database-Asgard-2018.txt"
)
df_health_encoding = find_encoding("./data/df_health.txt")


df1 = pd.read_csv(
    "./data/Global-Artificial-Intelligence-Database-Asgard-2018.csv",
    encoding="ISO-8859-1",
)
            ...
            html.Div(
                children=[
                    dcc.Dropdown(
                        id='field-dropdown2',
                        options=[
                            {'label': df, 'value': df} for df in dataframes_indeed
                        ],
                        value="Germany",
                    ),
                    DataTable(
    ...
    p1 = html.P(
        children=[
            ...
            html.A(
                ...
                href="https://asgard.vc/global-ai/",
                target="_blank",
            ),
            html.H2(),
            html.Span("Job data from "),
            html.A(
                "https://de.indeed.com", href="https://de.indeed.com/", target="_blank"
            ),
        ]
    )
...
# Display ds table
@app.callback(
    dash.dependencies.Output('table_indeed', 'rows'),
    [dash.dependencies.Input('field-dropdown2', 'value')],
)
...
def update_download_link(rows):
    ...
    txt_string2 = dff2.to_csv(index=False, header=True, sep="\t")
